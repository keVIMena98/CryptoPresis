...
function App() {
  ...
  const [feedback, setFeedback] = useState("Try your luck at minting a Legendary Ultra-Rare CryptoPresi.");
  ...
  const claimNFTs = (_amount) => {
    ...
    setClaimingNft(true);
     blockchain.smartContract.methods
      ...
      .then((receipt) => {
        setFeedback(
          "WOW, you now own a CryptoPresi. go visit Opensea.io to view it."
        );
        setClaimingNft(false);
              ...
              <>
                ...
                blockchain.smartContract === null ? (
                  ...
                  <s.Container ai={"center"} jc={"center"} fd={"row"}>
                    ...
                    >
                      {claimingNft ? "BUSY MINTING" : "BUY 1"}
                    </StyledButton>
                    <s.SpacerSmall />
                    <StyledButton
                      disabled={claimingNft ? 1 : 0}
                    ...
                    >
                      {claimingNft ? "BUSY MINTING" : "BUY 2"}
                    </StyledButton>
                    <s.SpacerSmall />
                    <StyledButton
                      disabled={claimingNft ? 1 : 0}
