                ...
                <Nav scrollNav={scrollNav}>
                    <NavbarContainer>
                        ...
                        <NavMenu>
                            ...
                            <NavItem>
                                <NavLinksR to="/Mint" smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                                    BUY A PRESI
                                </NavLinksR>
                            </NavItem>
                            <NavItem>
                                <NavLinksR to="/Roadmap" smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                                    ROADMAP
                                </NavLinksR>
                            </NavItem>
                            <NavItem>
                                <NavLinksR to="/Collection" smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                                    COLLECTION
                                </NavLinksR>
                            </NavItem>
                            <NavItem>
                                <NavLinksR to="/Team" smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                                    TEAM
                                </NavLinksR>
                            </NavItem>
                            <NavItem>
                                <NavLinksR to="/FAQ" smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                                    FAQ
                                </NavLinksR>
                            </NavItem>
