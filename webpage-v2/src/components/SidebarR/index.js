        ...
        <SidebarContainer isOpen={isOpen} >
            ...
            <SideBarWrapper>
                <SidebarMenu>
                    ...
                    <SidebarItem>
                        <SidebarLinksR to="Mint" onClick={toggle} smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                            BUY A PRESI
                        </SidebarLinksR>
                    </SidebarItem>
                    <SidebarItem>
                        <SidebarLinksR to="Roadmap" onClick={toggle} smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                            ROADMAP
                        </SidebarLinksR>
                    </SidebarItem>
                    <SidebarItem>
                        <SidebarLinksR to="Collection" onClick={toggle} smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                            COLLECTION
                        </SidebarLinksR>
                    </SidebarItem>
                    <SidebarItem>
                        <SidebarLinksR to="Team" onClick={toggle} smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                            TEAM
                        </SidebarLinksR>
                    </SidebarItem>
                    <SidebarItem>
                        <SidebarLinksR to="FAQ" onClick={toggle} smooth={true} duration={500} spy={true} exact='true' offset={-100}>
                            FAQ
                        </SidebarLinksR>
                    </SidebarItem>
